...
ENV_SPEC = [
    ...
    {
        "key": "DEV_AUTOFILL", "group": "서버", "label": "로그인 자동 입력 (개발용)", "type": "bool",
        "secret": False, "placeholder": "0",
        "what": "1이면 로그인 화면에 아이디와 비밀번호가 미리 채워져, 버튼만 누르면 들어갑니다.",
        "why": "⚠ 이걸 켜면 비밀번호를 아는 것과 같은 상태가 됩니다. 화면을 연 사람은 "
               "누구나 버튼 한 번으로 들어올 수 있어, 잠금이 사실상 없는 것과 같습니다. "
               "내 PC에서 개발할 때만 켜고, 인터넷에 올린 주소에서는 반드시 끄세요.",
    },
    {
